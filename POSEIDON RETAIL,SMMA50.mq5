//+------------------------------------------------------------------+
//|                           POSEIDON RETAIL,SMMA50                  |
//|  Version finale avec 3 signaux + 3 filtres                      |
//|  SIGNAUX: EMA21/55 + MACD histogramme + SMMA50/200 H1            |
//|  FILTRES: RSI H4 + SMMA50 H4 + Sentiment Retail Myfxbook         |
//|  H1 – Entrées 6:00-15:00 (serveur)                               |
//|  Règle: X/3 signaux (configurable), persistance, anti-retail     |
