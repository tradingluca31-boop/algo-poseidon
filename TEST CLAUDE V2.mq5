//+------------------------------------------------------------------+
//|                                   TEST CLAUDE V2 - 3 Signaux 2/3  |
//|  Version avec 3 signaux: EMA21/55 + MACD + SMMA50/200 H1         |
//|  H1 – Entrées 6:00-15:00 (serveur)                               |
//|  Règle: 2/3 signaux alignés pour valider entrée                   |
//|  Max 4 trades/jour, SL 0.35%, TP 1.75%                           |
//|  BE dès profit >= 1% OU move >= 3R                               |
//|  Filtres: RSI H4 + SMMA50 H4                                     |
//+------------------------------------------------------------------+
#property strict
