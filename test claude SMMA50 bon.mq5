//+------------------------------------------------------------------+
//|                           TEST CLAUDE SMMA50 BON - 3 Signaux      |
//|  Version avec croisement SMMA50/200 H1 corrigé                   |
//|  3 signaux: EMA21/55 + MACD histogramme + SMMA50/200 H1          |
//|  H1 – Entrées 6:00-15:00 (serveur)                               |
//|  Règle: X/3 signaux alignés (configurable)                       |
//|  Max 4 trades/jour, SL 0.35%, TP 1.75%                           |
//|  Filtres: RSI H4 + SMMA50 H4 - Persistance des signaux          |
//+------------------------------------------------------------------+
#property strict
